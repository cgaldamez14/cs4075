/*
	...
	Description: Program asks user to enter the order of the vectors. The order of the vectors
				 ...
				 of vector addition. Difference from first implementation is that 'MPI_Type_contiguous'
				 method is used to create a new MPI_Datatype.
*/
